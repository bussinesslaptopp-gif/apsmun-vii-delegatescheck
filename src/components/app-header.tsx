                ...
                <nav className="hidden md:flex items-center gap-2">
                     <Link href="/">
                        <Button variant="secondary">
                           <UserCheck className="mr-2 h-4 w-4" /> Universal Verification
                        </Button>
                    </Link>
                </nav>
                        ...
                        <SheetContent side="left" className="w-64 bg-background/95 backdrop-blur-sm p-0">
                            <div className="flex flex-col h-full">
                                ...
                                <nav className="flex-grow p-4 space-y-2">
                                     <Link href="/" onClick={() => setOpen(false)} className="flex items-center gap-3 rounded-lg px-3 py-2 text-primary bg-muted transition-all hover:text-primary">
